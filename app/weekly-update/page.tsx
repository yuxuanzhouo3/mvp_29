...
import { Mic, Smartphone, Zap, Shield, Sparkles, ArrowRight, CheckCircle2, QrCode, Globe, Radio, MessageSquare, Share2, Wifi, PhoneOff, Mail, LogIn, Cloud, Lock } from "lucide-react"
      ...
      <section className="min-h-[90vh] flex flex-col items-center justify-center relative overflow-hidden p-6">
        ...
        >
          ...
          <p className="text-xl md:text-3xl text-muted-foreground font-light leading-relaxed">
            本周我们带来了三个重磅更新：<br />
            <span className="text-primary font-medium">全双工实时语音通话翻译</span>、<span className="text-[#07C160] font-medium">微信小程序原生体验</span> 与 <span className="text-blue-500 font-medium">国际版移动端谷歌登录</span>
          </p>
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              className="space-y-8"
            >
              <div className="inline-flex items-center gap-2 text-blue-600 font-semibold tracking-wider uppercase text-sm">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                面向全球用户，支持 Google 账号一键快捷登录。打破地域限制，让每一次跨国协作都从最便捷的开始。
              </p>
              ...
              <div className="grid gap-6">
                <DetailCard
                  ...
                  title="秒级接入"
                  desc="无需繁琐注册流程，使用 Google 账号即可一键授权登录，即刻开启会议。"
                />
                <DetailCard
                  icon={<Cloud className="w-5 h-5 text-sky-500" />}
                  title="云端同步"
                  desc="账户信息与会议记录全球节点实时同步，无论身在何处，数据随行。"
                />
                <DetailCard
                  icon={<Lock className="w-5 h-5 text-indigo-500" />}
                  title="企业级安全"
                  desc="遵循 OAuth 2.0 标准协议，保障账户安全与隐私数据合规。"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 to-indigo-500/20 rounded-3xl blur-3xl -z-10" />
              <div className="bg-background border border-border/50 rounded-3xl shadow-2xl p-8 md:p-12 relative overflow-hidden w-full max-w-md">
                <div className="space-y-8">
                  <div className="text-center space-y-4">
                    <div className="w-20 h-20 bg-primary/10 rounded-2xl mx-auto flex items-center justify-center mb-6">
                      <Image src="/logo.png" width={48} height={48} alt="Logo" className="rounded-lg" />
                    </div>
                    <h3 className="text-2xl font-bold">Welcome Back</h3>
                    <p className="text-muted-foreground">Sign in to continue to MornSpeaker</p>
                  </div>

                  <div className="space-y-4 pt-4">
                    <button className="w-full bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 font-medium py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-all hover:shadow-md group">
                    ...
                    <div className="space-y-3 opacity-40 pointer-events-none select-none filter blur-[1px]">
                      <div className="h-12 bg-muted rounded-xl w-full" />
                      <div className="h-12 bg-primary rounded-xl w-full" />
                    </div>
                  </div>
                </div>
              </div>
